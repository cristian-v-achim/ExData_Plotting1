...
par(mfrow=c(2,2))
plot(submydata$Time,submydata$Global_active_power,type="l",ylab="Global Active Power (kilowtts)",xlab="")

plot(submydata$Time,submydata$Voltage,type="l",ylab="Voltage",xlab="datetime")

plot(submydata$Time,submydata$Sub_metering_1,col="black",xlab="",ylab="Energy submetering",type="l")
...
plot(submydata$Time,submydata$Global_reactive_power,type="l",xlab="")
dev.off()